...
object ScalaStreamJoin {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val line = env.addSource(new StringLineEventSource(10))
    ...
    val joinStream = watermark.join(watermark2).where(_._4).equalTo(_._4).window(TumblingEventTimeWindows.of(Time.seconds(5))).apply{
