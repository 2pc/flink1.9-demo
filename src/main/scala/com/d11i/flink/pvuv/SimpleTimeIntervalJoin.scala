...
object SimpleTimeIntervalJoin {
  def main(args: Array[String]): Unit = {
    ...
    val sqlRet = tEnv.sqlQuery(sqlQuery)
    sqlRet.toAppendStream[Row].print()
    println(tEnv.explain(sqlRet))
//    tEnv.registerTable("TemporalJoinResult", sqlRet)
//    //
//    println("=====================================================")
//    var sqlQuery2 =
//      """
...
//        | o.orderId = p.orderId AND p.payTime >= orderTime AND p.payTime < TIMESTAMPADD(SECOND, 3600, orderTime)
//        |""".stripMargin
...
//        | *
//        |FROM
//        | Orders AS o INNER   JOIN Payment AS p ON
//        | o.orderId = p.orderId
//        |""".stripMargin
//
